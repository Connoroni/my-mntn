...
export default function Hero() {
  return (
    <header
      className={`h-[150vh] col-span-5 row-span-5 bg-cover bg-center bg-[url("https://assets.iflscience.com/assets/articleNo/73209/aImg/74597/longest-ocean-range-meta.jpg")] grid grid-cols-6 grid-rows-7 gap-4`}
    >
      ...
      <div className="col-span-2 col-start-3 row-start-3">
        <div className="flex flex-row justify-start gap-3 items-center">
          ...
          <h3 className="uppercase text-yellow-200">A Hiking Guide</h3>
        </div>
